...
def generate_launch_description():
    ...
    rviz_launch_rx150 = IncludeLaunchDescription(
        ...
        launch_arguments={'robot_model': 'rx150', 'use_joint_pub_gui': 'true' , 'robot_name' : 'rx150'}.items()
    )
    ...
    rviz_launch_vx300 = IncludeLaunchDescription(
        ...
        launch_arguments={'robot_model': 'vx300', 'use_joint_pub_gui': 'true' , 'robot_name' : 'vx300'}.items()
    )
